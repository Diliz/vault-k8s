	...
	tests := []struct {
	...
	}{
		{
			map[string]string{
				...
				"vault.hashicorp.com/agent-inject-leftdelim-barfoo":     "${",
				"vault.hashicorp.com/agent-inject-rightdelim-barfoo":    "}",
				...
				"vault.hashicorp.com/agent-inject-leftdelim-test3":     "",
				"vault.hashicorp.com/agent-inject-rightdelim-test3":    "",

				"vault.hashicorp.com/agent-inject-template-only-template-2":           "onlyTemplate2",
				"vault.hashicorp.com/agent-inject-leftdelim-only-template-2":          "${",
				"vault.hashicorp.com/agent-inject-rightdelim-only-template-2":         "}",
				"vault.hashicorp.com/agent-inject-template-file-only-template-file-2": "onlyTemplateFile2",
				"vault.hashicorp.com/agent-inject-leftdelim-only-template-file-2":     "${",
				"vault.hashicorp.com/agent-inject-rightdelim-only-template-file-2":    "}",
			},
			map[string]Secret{
				"foobar": {
					Name:         "foobar",
